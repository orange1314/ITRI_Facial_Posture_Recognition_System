...
import pickle
from Posture_ensemble_model_V3 import CombinedModel
...
def main(time_step):
    ...
    def evaluate_model(model, test_file_path):
        ...
        for action in action_correct:
            ...
            results.append(f'Accuracy for action {action}: {action_accuracy:.2f}%\n')
    ...
    train_losses = train_model(model, train_loader, criterion, optimizer, num_epochs=48)
